		...
		for(local i=0;i<objectManager.getCollisionObjectNumber();++i)
		{
			...
			if(object && !obj.isEnemy(object) && object.isObjectType(OBJECTTYPE_ACTIVE))
			{
				...
				if(index == 60040)
				{
					...
					sq_SendCreatePassiveObjectPacketPos(obj, 24398, 0, object.getXPos(), object.getYPos(),object.getZPos()+ object.getObjectHeight()/2);
...
//		createPaticleMap(obj, "passiveobject/common/particle/lightexplosionparticle1.ptl", x, y, z);
//		createPaticleMap(obj, "passiveobject/common/particle/lightexplosionparticle2.ptl", x, y, z);
//		createPaticleMap(obj, "passiveobject/common/particle/lightexplosionparticle3.ptl", x, y, z);
//		createPaticleMap(obj, "passiveobject/common/particle/lightexplosionparticle4.ptl", x, y, z);
