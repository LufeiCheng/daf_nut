function setCustomDataEtc_po_bloodcut(obj, receiveData) {
	...
	if (id == 224) {
		...
		local ani = obj.getVar().GetAnimationMap("0", "passiveobject/zrr_skill/gunblader/animation/basicattack/hitmanbullet_00.ani");
		...
		local angle = getRorateAngleByCurrentPos(obj, obj.getVar("pos").get_vector(0), obj.getVar("pos").get_vector(1), obj.getVar("pos").get_vector(2), obj.getVar("pos").get_vector(3), obj.getVar("pos").get_vector(4), obj.getVar("pos").get_vector(5));
	...
	if (id == 222) {
		local ani = obj.getVar().GetAnimationMap("0", "passiveobject/zrr_skill/newthier/animation/ballacreadvent/lasteffect_set02d15.ani");
		obj.setCurrentAnimation(ani);
		onSetStateBellacre_AdventObj(obj, 3);

	} else if (id == 221) {
		local ani = obj.getVar().GetAnimationMap("0", "passiveobject/zrr_skill/newthier/animation/ballacreadvent/bigballacre02_finger.ani");
		obj.setCurrentAnimation(ani);
		onSetStateBellacre_AdventObj(obj, 2);

	} else if (id == 220) {
		local ani = obj.getVar().GetAnimationMap("0", "passiveobject/zrr_skill/newthier/animation/ballacreadvent/bigballacre01_hand.ani");
		obj.setCurrentAnimation(ani);
		onSetStateBellacre_AdventObj(obj, 1);

	} else if (id == 219) {
		local ani = obj.getVar().GetAnimationMap("0", "passiveobject/zrr_skill/newthier/animation/ballacreadvent/beadstart02_set07n.ani");
		obj.setCurrentAnimation(ani);
		...
		if (rand < 33) {
			local ani = obj.getVar().GetAnimationMap("0", "passiveobject/zrr_skill/newthier/animation/livingdead/darkmatter/newdarkmatter2_01.ani");
			obj.setCurrentAnimation(ani);
		} else if (rand < 66) {
			local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/newthier/animation/livingdead/darkmatter/newdarkmatter2_01.ani");
			obj.setCurrentAnimation(ani);
		} else {
			local ani = obj.getVar().GetAnimationMap("2", "passiveobject/zrr_skill/newthier/animation/livingdead/darkmatter/newdarkmatter3_01.ani");
			obj.setCurrentAnimation(ani);
		}
		...
		local ani = obj.getVar().GetAnimationMap("0", "passiveobject/zrr_skill/newthier/animation/livingdead/start_livingdead.ani");
		obj.setCurrentAnimation(ani);

	} else if (id == 216) {
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/priest/animation/wrathofgod/finishatkeff_smoke.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/character/mage/animation/atflamecircle/exp/exp_front06.ani");
		obj.setCurrentAnimation(ani);
		local attackInfo = sq_GetCustomAttackInfo(obj, 183);
		sq_SetCurrentAttackBonusRate(attackInfo, attackBonusRate);
		sq_SetCurrentAttackInfo(obj, attackInfo);
	} else if (id == 214) {
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/priest/animation/nuclearpunch/nuclearpunch_attack_shockbackglow.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/priest/animation/demolitionpunch/demolitionpunch_c_shockb.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/priest/animation/gatlingpunch/boom_back.ani");
		obj.setCurrentAnimation(ani);
		...
		local fsObj = sq_flashScreen(obj, 100, 99999999, 0, 75, sq_RGB(245, 0, 249), GRAPHICEFFECT_NONE, ENUM_DRAWLAYER_COVER);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/fighter/animation/dragonmine/poisonloop_dragonmine_bottom.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/fighter/animation/dragonmine/explosion/boom_dragonmine_boom4.ani");
		obj.setCurrentAnimation(ani);
		...
		if (isOut == 1) obj.getVar("var").push_vector(receiveData.readDword());
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/fighter/animation/poisonexplosion/explosion_01_shockwave_d.ani");
		obj.setCurrentAnimation(ani);
		...
		sq_SetMyShake(obj, 10, 200);
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/fighter/animation/poisonexplosion/explosion_00_shockwave_n.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/atswordman/animation/atgonewiththepetal/explosiona2_02.ani");
		...
		if (target) sq_SendHitObjectPacketWithNoStuck(obj, target, 0, 0, 0);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/atswordman/animation/atfistofexplosion/shootfront_08.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/gunner/animation/deathcrisis/deathcrisisfinishmultihitshoot.ani");
		obj.setCurrentAnimation(ani);
		...
		local atkT = receiveData.readDword();
		if (atkT != -1) obj.setTimeEvent(0, atkT, 0, true);

	} else if (id == 202) {
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/gunner/animation/deathcrisis/deathcrisisfinishgunhawkattack.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/gunner/animation/deathcrisis/deathcrisisfrontshootattack.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/gunner/animation/deathcrisis/deathcrisisshootattack.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/zrr_skill/gunner/animation/deathcrisis/deathcrisismultishootattack.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("1", "passiveobject/character/swordman/animation/shockwaveareahold_.ani");
		obj.setCurrentAnimation(ani);
		...
		if (target) {
			...
			local masterAppendage = CNSquirrelAppendage.sq_AppendAppendage(target, obj, SKILL_BLOODBOOM, false, "character/newswordman/shockwavearea/ap_shockwavearea_new.nut", true);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/gunner/animation/trytread.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atgodwind/atgodwind_tornado_normal.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("DummyAni", "passiveobject/zrr_skill/atmage/animation/b30a/atstormstrikes/dummy.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("MulitingHitAni", "passiveobject/zrr_skill/priest/animation/doomcrush/doomcrush_boom_finishsmoke.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("MulitingHitAni", "passiveobject/zrr_skill/priest/animation/darkhowling/dh1_shockwave_normal.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("MulitingHitAni", "passiveobject/zrr_skill/newswordman/animation/mulitinghit.ani");
		obj.setCurrentAnimation(ani);
		...
		if (object) obj.getVar("dama").push_obj_vector(object);

	} else if (id == 188) {
		local ani = obj.getVar().GetAnimationMap("bloodyRave", "character/swordman/animation/bloodyravedummy.ani");
		obj.setCurrentAnimation(ani);
		local mage = obj.getTopCharacter();
		mage = sq_ObjectToSQRCharacter(mage);
		local attackInfo = sq_GetCurrentAttackInfo(mage);
		...
		local ani = obj.getVar().GetAnimationMap("BigJangLaunchBody", "passiveobject/zrr_skill/atswordman/animation/atbigjang/normal_throw_hand.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("ZweivolTageExVertexSlashExplosionAnimation", "passiveobject/zrr_skill/atswordman/animation/atzweivoltage/explosion/zweivoltage_finisheff_leaf_00.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("GhostStepSlashMainBody", "character/swordman/animation/zrr/ghoststepslash_dummy.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("FatalFlowerMainBody", "passiveobject/zrr_skill/atswordman/animation/atfatalflower/newhellfireb_21.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("BlastSwordExplosionEffect", "passiveobject/zrr_skill/atswordman/animation/atblastsword/boom_base.ani");
		obj.setCurrentAnimation(ani);
		...
		local atk2 = receiveData.readDword();
		local hitCount = receiveData.readDword();
		local ani = obj.getVar().GetAnimationMap("OverBlowSlashBody", "passiveobject/zrr_skill/atswordman/atoverblowslash/overblowslashneweffect_23.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("EarthPressureMain", "passiveobject/zrr_skill/atswordman/animation/atearthpressure/flooreffect.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("NearBlowDummyHitObject", "passiveobject/zrr_skill/atswordman/animation/atnearblow/pierce_throw(d).ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("SpaceIgniteMainBody", "passiveobject/zrr_skill/atswordman/animation/atspaceignite/explosion_ex.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("CommonAnimationShockAnimation", "passiveobject/zrr_skill/atswordman/animation/atinhalation/shock.ani");
		obj.setCurrentAnimation(ani);
		...
		local distance = receiveData.readDword();
		local ani = obj.getVar().GetAnimationMap("AtSwordManThreeSide", "passiveobject/zrr_skill/atswordman/animation/atthreeside/threeside_03.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("AccelnationalTriggerShootDEffect", "character/gunner/animation/ani_als/accelationtrigger_second/accelationtriggershootd_00.ani");
		obj.setCurrentAnimation(ani);
		...
		sq_SetMyShake(obj, 10, 200);
		local ani = obj.getVar().GetAnimationMap("devilBoomEffect", "passiveobject/zrr_skill/priest/animation/inviteofdevil/devilinvitation_boom_04.ani");
		local isAwake = receiveData.readDword();
		if (isAwake == 1) {
			ani = obj.getVar().GetAnimationMap("devilBoomEffectBoom", "passiveobject/zrr_skill/priest/animation/inviteofdevil/devilinvitation_boom_04.ani");
		}
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("devilLeft", "passiveobject/zrr_skill/priest/animation/inviteofdevil/devilinvitation_left_03.ani");
		if (isAwake == 1) {
			ani = obj.getVar().GetAnimationMap("devilLeftAW", "passiveobject/zrr_skill/priest/animation/inviteofdevil/devilinvitation_w_left_04.ani");
		}
		obj.setCurrentAnimation(ani);
		...
		obj.getVar("isAwake").clear_vector();
		obj.getVar("isAwake").push_vector(isAwake);
		local ani = obj.getVar().GetAnimationMap("devilRight", "passiveobject/zrr_skill/priest/animation/inviteofdevil/devilinvitation_right_04.ani");
		if (isAwake == 1) {
			ani = obj.getVar().GetAnimationMap("devilRightAW", "passiveobject/zrr_skill/priest/animation/inviteofdevil/devilinvitation_w_right_03.ani");
		}
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("CoalBan", "passiveobject/character/swordman/animation/atcoalban/shooting.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("AtExectionMain", "passiveobject/zrr_skill/atswordman/animation/atexecution/start_md.ani");
		...
		local ani = obj.getVar().GetAnimationMap("ShootEffect", "passiveobject/zrr_skill/gunner/animation/fastdraw/fastdraw_bullet_normal.ani");
		...
		local angle = getRorateAngleByCurrentPos(obj, obj.getVar("moveInitVar").get_vector(1), obj.getVar("moveInitVar").get_vector(2), obj.getVar("moveInitVar").get_vector(3), obj.getVar("moveVar").get_vector(0), obj.getVar("moveVar").get_vector(1), obj.getVar("moveVar").get_vector(2));
	...
	if (id == 159) {
		local ani = obj.getVar().GetAnimationMap("Dummy", "passiveobject/zrr_skill/fighter/animation/double_dragon/dummy.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("Dummy6", "passiveobject/zrr_skill/newswordman/animation/sprit_swordman/infinitykilling/onehitdummy.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("Dummy5", "passiveobject/zrr_skill/newswordman/animation/sprit_swordman/infinitykilling/onehitdummy.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("Dummy4", "passiveobject/zrr_skill/newswordman/animation/sprit_swordman/infinitykilling/onehitdummy.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("Dummy3", "passiveobject/zrr_skill/newswordman/animation/sprit_swordman/infinitykilling/multihitdummy2.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("Dummy2", "passiveobject/zrr_skill/newswordman/animation/sprit_swordman/infinitykilling/multihitdummy1.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("Dummy1", "passiveobject/zrr_skill/newswordman/animation/sprit_swordman/infinitykilling/onehitdummy.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("SiryumMain", "passiveobject/zrr_skill/atswordman/animation/atsiryun/siryungum.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("RampantMadness", "passiveobject/zrr_skill/newswordman/animation/rampantmadness/rampantmadnessattackcfront_00.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("RampantMadness", "passiveobject/zrr_skill/newswordman/animation/rampantmadness/rampantmadnessattackbfront_00.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("SpritMagicWoodHoldAnimationStart", "passiveobject/zrr_skill/newmage/animation/hex/hex_dollhit_start_04.ani");
		obj.setCurrentAnimation(ani);
		obj.setCurrentPos(activeObj.getXPos(), activeObj.getYPos() + 3, activeObj.getZPos() + activeObj.getObjectHeight() / 2);
		...
		obj.getVar("obj").push_obj_vector(createSpritMagicChangeTargetByID(activeObj, getSpritMagicTargetVarByObject(activeObj)));
		...
		local ani = obj.getVar().GetAnimationMap("SpritMagicWoodHoldAnimation", "passiveobject/zrr_skill/newmage/animation/hex/hex_dollwait.ani");
		obj.setCurrentAnimation(ani);

	} else if (id == 141) {
		local ani = obj.getVar().GetAnimationMap("stateFinvisibleSwordFlowMindThreeKatana", "passiveobject/zrr_skill/newswordman/animation/stateofinvisiblesword/flowmindthree/flowmindlv95katanathree_katanathreeslashl.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("stateFinvisibleSwordFlowMindTwoKatana", "passiveobject/zrr_skill/newswordman/animation/stateofinvisiblesword/flowmindtwo/flowmindlv95katanatwo_katanatwoslash.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("explosionofpathMain", "passiveobject/chunjie/swordman/asura/animation/explosionofpath/endfront_27.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("GluttonySlashExplosionEffect", "passiveobject/zrr_skill/newswordman/animation/gluttonycrevasse/gluttonycrevasseexplosion_08.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("GluttonySlashBladeEffect", "passiveobject/zrr_skill/newswordman/animation/gluttonycrevasse/gluttonycrevassebladespark_05.ani");
		obj.setCurrentAnimation(ani);
		...
		local moveDistance = receiveData.readDword();
		local ani = obj.getVar().GetAnimationMap("HardAttackDemonicCrownSlash", "passiveobject/character/swordman/animation/hardattackcharge/bladepantom_bladepantombody.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("MoonLightSlashExplosion", "passiveobject/zrr_skill/newswordman/animation/moonlightslash/moonexplosion_00.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("EpidRasaLoop", "passiveobject/character/swordman/animation/epidemicrasa/rasa.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("ContinueFireBullet", "passiveobject/zrr_skill/gunblader/animation/continuousfire/bullet_00.ani");
		obj.setCurrentAnimation(ani);

		local attackInfo = sq_GetCustomAttackInfo(obj, 112);
		if (flagIndex == 3) attackInfo = sq_GetCustomAttackInfo(obj, 113);
		...
		local ani = obj.getVar().GetAnimationMap("SightingShootBullet", "passiveobject/zrr_skill/gunblader/animation/sigtingshot/bullet_00.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("sestoElementoMulit", "passiveobject/zrr_skill/newmage/animation/sestoelemento/start_main.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("ElementalCurtainExplosionEffect", "passiveobject/zrr_skill/newmage/animation/elementalcurtain/elementalcurtain_auroraend_broken.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/stateoflimit/illusionslash/state_of_limit_illusion_wave_shadow.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/zigadvent/ghostwind/ghostwind_1.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/flame/flame_dodge.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/weapon_katana_blood/atk.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/invisiblebladeswordcut/slasheffectb_00.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/invisiblebladeswordcut/slasheffecta_67.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/character/swordman/animation/kalla/shadowland2.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atviolentstorm/stormend_19.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atbloodwing/bloodwingmove_01.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atgodwind/last.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atfighter/animation/atdropfire/atdropfire_boom_06.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atdimensionlay/atk2.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atnyarlyatg/g/gstart_body.ani");
		obj.setCurrentAnimation(ani);
		obj.getVar("flag").clear_vector();
		obj.getVar("flag").push_vector(0);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atnyarlyatg/word/g_word_nomal.ani");
		obj.setCurrentAnimation(ani);
		obj.getVar("flag").clear_vector();
		obj.getVar("flag").push_vector(0);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/ataccident/accident_shock_a01.ani");
		if (isBoom == 1) {
			//            ani = obj.getCustomAnimation(162);
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/ataccident/accident_shock_b03.ani");
		}
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/ataccident/accident_box_a01.ani");

		local attackInfo = sq_GetCustomAttackInfo(obj, 82);
		if (isBoom == 1) {
			//            ani = obj.getCustomAnimation(160);
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/ataccident/accident_box_b01.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/ataccident/accident_magiccircle_a01.ani");

		if (isBoom == 1) {
			//            ani = obj.getCustomAnimation(158);
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/ataccident/accident_magiccircle_b01.ani");
		}
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atswarm/swarm_02.ani");
		obj.setCurrentAnimation(ani);
	...
	} else if (id == 104) //blackHole
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atpositron/alaser_03.ani");
		if (etcID == 1) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atpositron/blaser_03.ani");
		} else if (etcID == 2) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atpositron/blasera_03.ani");
		}
		...
		if (etcID == 0) {
			...
			addPartlcAniBlockHole_1(obj, "passiveobject/zrr_skill/atmage/animation/atpositron/2crackloop_01.ani", 510 - 45, -140, -39);

			addPartlcAniBlockHole_1(obj, "passiveobject/zrr_skill/atmage/animation/atpositron/3crackloop_01.ani", 582 - 45, 32, -39);

			addPartlcAniBlockHole_1(obj, "passiveobject/zrr_skill/atmage/animation/atpositron/1acrackloop_01.ani", 45 - 45, 1, 0);

			addPartlcAniBlockHole_1(obj, "passiveobject/zrr_skill/atmage/animation/atpositron/bcenterloop_10.ani", 300 - 45, 1, 0);
		}
	...
	} else if (id == 102) //particleLine
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atdimensionlay/atk1.ani");
		obj.setCurrentAnimation(ani);
	...
	} else if (id == 101) //timeTape
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atcorridor/start/corridor_start_up.ani");
		obj.setCurrentAnimation(ani);
	...
	} else if (id == 100) //NewBloodSong
	{
		...
		ani.setImageRateFromOriginal(mage.sq_GetIntData(SKILL_BLOODSONG, 29).tofloat() / 100.0, mage.sq_GetIntData(SKILL_BLOODSONG, 30).tofloat() / 100.0);
	...
	} else if (id == 98) //BloodAndShaow LastEffect
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newthier/animation/zetsuei/lastattackeffect/exp01_normal01.ani");
	...
	} else if (id == 97) //bloodshaowslash_drophitpassiveobject
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newthier/animation/finaldistruction/finaldestruction_finish_crash.ani");
		obj.setCurrentAnimation(ani);
	...
	} else if (id == 96) //shaowarea_shadownormalattack
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newthier/animation/gotohell/gotohell_finish2_smoke_a.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/tombstoneswamp/explosion_02.ani");
	...
	} else if (id == 92) //119
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/character/swordman/animation/bloodswordexplosion/explosion_28.ani");
	...
	} else if (id == 91) //119
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newmage/animation/dot/maddefance/maddyguard2/maddyguardclaw_00.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/stateoflimit/state_of_limit_illusion_02.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/stateoflimit/state_of_limit_illusion_01.ani");
		obj.setCurrentAnimation(ani);
		local attackInfo = sq_GetCustomAttackInfo(obj, 54);
		sq_SetCurrentAttackInfo(obj, attackInfo);
		attackInfo = sq_GetCurrentAttackInfo(obj);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/stateoflimit/state_of_limit_illusion_00.ani");
		obj.setCurrentAnimation(ani);
		local attackInfo = sq_GetCustomAttackInfo(obj, 54);
		sq_SetCurrentAttackInfo(obj, attackInfo);
		attackInfo = sq_GetCurrentAttackInfo(obj);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/stateoflimit/state_of_limit_dragon_02.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/stateoflimit/state_of_limit_backstep_01.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/stateoflimit/state_of_limit_crash_05.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/bloodboom/bloodsnatchboomf_12.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/gunner/animation/wipeout/wipeoutattack02_hitf_02.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/gunner/animation/wipeout/wipeoutattack01_12.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/gunner/animation/deadlyapproach/shooteffect_1.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atd_force/atd_force_finish_boom3_18.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atd_force/atd_spear_force_finish_boom2_5.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atd_force/atd_force_finish_boom1_6.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atd_force/atd_force_att_circle_2.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atd_force/atd_force_holding_eff.ani");
		obj.setCurrentAnimation(ani);
		local attackInfo = sq_GetCustomAttackInfo(obj, 41);
		sq_SetCurrentAttackInfo(obj, attackInfo);
		...
		if (sq_getRandom(0, 2) > 1) {
			...
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newmage/animation/rosevine/rosevine01_00.ani");
		} else {
			//            ani = obj.getCustomAnimation(87);
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newmage/animation/rosevine/rosevine02_00.ani");
		}
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atshardmagnum/shardmagnumstep2_02handglow.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atshardmagnum/shardmagnumstep1_01iceboom4.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/bloodrivern/bloodrivenexplosion.ani");
		obj.setCurrentAnimation(ani);
		...
		if (is == 1) //0 == in 1 == out
		{
			...
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atshikaree/shikaree_a_floor01.ani");
			obj.getVar("value").push_vector(jinPos);
		} else {
			//            ani = obj.getCustomAnimation(79);
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atshikaree/shikaree_b_floor01.ani");
		...
		obj.getVar("isSum").push_vector(0);
		obj.getVar("isSum").push_vector(countT);
	} else if (id == 58) {
		local size = receiveData.readDword();
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/attorment/atk.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atcorruption/c/corruptionteethgrabcannonfrontend_eff_08.ani");
		if (id2 == 1) {
			//            ani = obj.getCustomAnimation(70);
			ani = obj.getVar().GetAnimationMap("20", "passiveobject/zrr_skill/atmage/animation/atcorruption/b/corruptionteethawakefrontend_teeth_02.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atcorruption/c/corruptionteethgrabcannonfrontloop_eff_08.ani");
		if (id2 == 1) {
			//            ani = obj.getCustomAnimation(70);
			ani = obj.getVar().GetAnimationMap("20", "passiveobject/zrr_skill/atmage/animation/atcorruption/b/corruptionteethawakefrontloop_teeth_00.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atcorruption/c/corruptionteethgrabcannonfrontstart_eff_08.ani");
		if (id2 == 1) {
			//            ani = obj.getCustomAnimation(70);
			ani = obj.getVar().GetAnimationMap("20", "passiveobject/zrr_skill/atmage/animation/atcorruption/b/corruptionteethawakefrontstart_teeth_00.ani");
		...
		if (id == 46) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/addwave/light/addwave1.ani");
		} else if (id == 47) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/addwave/light/addwave2.ani");
		} else if (id == 48) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/addwave/light/addwave3.ani");
		}
		obj.setCurrentAnimation(ani);
		...
		if (id == 46) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/addwave/addwave1.ani");
		} else if (id == 47) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/addwave/addwave2.ani");
		} else if (id == 48) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/addwave/addwave3.ani");
		}
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/forceofthunderer/lightningpower_eff_a.ani");
	...
	} else if (id == 38) //no attack
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/lightninggod/lightning_create/1/god/1_god.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/vajra/vajra_finish_exp_lightning_b.ani");
		obj.setCurrentAnimation(ani);
		...
		sq_SetMyShake(obj, 2, 100);
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/vajra/vajra_finish_break.ani");
		obj.setCurrentAnimation(ani);
		...
		if (id2 == 0) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/vajra/vajra_bullet_main_a.ani");
		} else if (id2 == 1) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/vajra/vajra_bullet_main_b.ani");
		} else if (id2 == 2) {
			ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/vajra/vajra_bullet_main_c.ani");
		}
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/indaramang/attack_wave.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atgodwind/atgodwind_finish_tornado2.ani");
		obj.setCurrentAnimation(ani);
		local attackInfo = sq_GetCustomAttackInfo(obj, 15);
		sq_SetCurrentAttackInfo(obj, attackInfo);
		attackInfo = sq_GetCurrentAttackInfo(obj);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/attornado/tornado_projectile_eff01.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atspiralpress/atspiralpress_shoot.ani");
		obj.setCurrentAnimation(ani);
	...
	} else if (id == 23) //raginwind-hold
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atragingwind/ragingwind_d_twister_dust01.ani");
		obj.setCurrentAnimation(ani);
	...
	} else if (id == 22) //raginwind-hold
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atragingwind/ragingwind_c_twister_eff01.ani");
		obj.setCurrentAnimation(ani);
	...
	} else if (id == 21) //raginwind-hold
	{
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atragingwind/ragingwind_a_dust01.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/athurricane_new/hurricane_b.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/athurricane_new/hurricane_a.ani");
		obj.setCurrentAnimation(ani);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atstormquake/stormquake_b02_wind_loop07.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/gunner/animation/dropbomblight.ani");
		obj.setCurrentAnimation(ani);
		local attackInfo = sq_GetCurrentAttackInfo(obj);
		sq_SetCurrentAttackBonusRate(attackInfo, attackBonusRate);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/bloodboom/boom_dodge.ani");
		obj.setCurrentAnimation(ani);
		local attackInfo = sq_GetCurrentAttackInfo(obj);
		sq_SetCurrentAttackBonusRate(attackInfo, attackBonusRate);
		return true;
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/bladephantomex/bladephantomex_crack_explosion02.ani");
		...
		if (object.getState() != STATE_HOLD) {
			...
			masterAppendage = CNSquirrelAppendage.sq_AppendAppendage(object, obj, SKILL_HARDATTACK_HELL, false, "character/newswordman/hardattack_hell/ap_hardattack_hell_flag.nut", true);
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/slashofhell/slashofhell_debuff_roof_dodge.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/slashofhell/slashofhell_att_eff_27.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/atfang/blood_awake/atfang_attack_awake.ani");
		obj.setCurrentAnimation(ani);
		local size = receiveData.readDword();
		local currentAni = sq_GetCurrentAnimation(obj);
		local sizeRate = size.tofloat() / 100.0;
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/atmage/animation/newblooddoghold/ready.ani");
		...
		local ani = obj.getVar().GetAnimationMap("SwordOfMindNew", "passiveobject/zrr_skill/swordman/animation/swordofmind/newhit.ani");
		...
		local ani = obj.getVar().GetAnimationMap("", "passiveobject/zrr_skill/newswordman/animation/slashofboom/slashofboom_expl_ghost.ani");
		obj.setCurrentAnimation(ani);
...
function onSetState_TIMETAPE(obj, state, datas, isResetTimer) {
	...
	if (state == 0) {
		...
		if (obj.isMyControlObject()) sq_flashScreen(obj, 560, 80, 0, 204, sq_RGB(0, 0, 0), GRAPHICEFFECT_NONE, ENUM_DRAWLAYER_BOTTOM);
